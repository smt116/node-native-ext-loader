...
### `loadFromRoot` (default: `undefined`)

It allows to load the file as it is from the root. This option is useful when cannot rely on the `__dirname` when it points to the `node_modules`'s subdirectory.
